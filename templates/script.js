...
function thisIsLoading() {
    ...
    loadingImage.setAttribute("src", "https://upload.wikimedia.org/wikipedia/commons/a/ad/YouTube_loading_symbol_3_%28transparent%29.gif");
    addRoom.innerHTML = '';
    addRoom.appendChild(loadingImage);
}
